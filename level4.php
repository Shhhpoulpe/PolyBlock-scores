...
<div class="head">
	...
	<a href='level5.php'><button> Level 5 </button></a>	
</div>
...
try
{
	$sql="SELECT niveau, pseudo, temps FROM scores,joueurs WHERE scores.IDJoueur = joueurs.id AND niveau = 4 ORDER BY temps LIMIT 10";
